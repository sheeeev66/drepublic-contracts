...
// OpenZeppelin Contracts v4.3.2 (token/ERC721/presets/ERC721AutoId.sol)
    ...
    ERC721Pausable
{
    ...
    function mint(address to) public virtual {
        require(
            ...
            "ERC721AutoId: must have minter role to mint"
        );
    ...
    function setCounter(uint256 tokenId) external {
        require(
            hasRole(MINTER_ROLE, _msgSender()),
            "ERC721AutoId: must have minter role to set counter"
        );

        _tokenIdTracker._value = tokenId;
    }
    ...
    function pause() public virtual {
        require(
            ...
            "ERC721AutoId: must have pauser role to pause"
        );
        _pause();
    }
    ...
    function unpause() public virtual {
        require(
            hasRole(PAUSER_ROLE, _msgSender()),
            "ERC721AutoId: must have pauser role to unpause"
        );
        _unpause();
    }
